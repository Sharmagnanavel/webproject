		...
		try {
			...
			if(n!=0)
			{
				...
				writer.print("<!DOCTYPE html>\r\n"
						...
						+ "<body>\r\n"
						+ "    <h1>Success!</h1>\r\n"
						+ "    <p>Employee data has been successfully updated in the database.</p>\r\n"
				...
				writer.print("<!DOCTYPE html>\r\n"
						...
						+ "<body>\r\n"
						+ "    <h1>Failure!</h1>\r\n"
						+ "    <p>Employee data could not be saved. Please check the details and try again.</p>\r\n"
						+ "    <button onclick=\"window.location.href='editform.html';\">Back to Employee Update Page</button>\r\n"
						+ "</body>\r\n"
						+ "</html>\r\n"
						+ "");
			}
